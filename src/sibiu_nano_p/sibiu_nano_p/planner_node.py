...
from uuv_interfaces.srv import Newpoint, ASVmode, CommandBool, CommandStr
from uuv_interfaces.msg import Status, Nodeupdate, Location
from uuv_interfaces.action import Samplepoint
...
class Planner_node(Node):
    ...
    def parameters(self):
        self.declare_parameter('map_filename', 'zufre')
        path = "~/Sibiu_Nano_P/mapas/" + self.get_parameter('map_filename').get_parameter_value().string_value
