...
def main():
    ...
    grid_size= 20     #size of the grid in meters
    ...
    aux0=0
    while aux0!="y" and aux0!="n":
        aux0=input("is there already an existing image (y/n)").lower()
    if aux0=='n':
        try:
        ...
        img=Image.open("high_resolution_image2.png")
    #Show the image
    #plt.figure()
    #plt.imshow(img, cmap=plt.get_cmap('binary'))
    #plt.show()
